    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(default=22, null=True, on_delete=django.db.models.deletion.CASCADE, to='inventory.item')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='patient.patient')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('labResult', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='laboratory.labtestresult')),
                ('labTech', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='labTech_attendance_processes', to=settings.AUTH_USER_MODEL)),
                ('labTest', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='laboratory.processtestrequest')),
                ...
                ('qualitativeLabTest', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='laboratory.labtestresultqualitative')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='patient.patient')),
