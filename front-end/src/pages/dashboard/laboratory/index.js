...
import { getAllLabRequests, getAllLabResults, getAllLabTestProfiles, getAllQualitativeLabResults } from "@/redux/features/laboratory";
...
const LabResults = () => {
  ...
  useEffect(() => {
    if (token) {
      ...
      dispatch(getAllLabTestProfiles(token));
