...
export default async function handler(req, res) {
    if (req.method === API_METHODS.GET) {
        try {
            ...
            console.log("PERMIsSION_ROLES ",`${API_URL.GET_USER_PERMISSIONS}/${userId}`)
    
            await backendAxiosInstance.get(`${API_URL.GET_USER_PERMISSIONS}/${userId}`, config).then(response => {
