...
const UserDetailsUpdateForm = ({auth, selectedRowData, loading, setLoading, handleClose}) => {
    ...
    <section className="space-y-2">
      ...
      <Grid container spacing={2}>
        <Grid item md={12} xs={12}>
          <label className="font-semibold px-2">Birth Date</label>
        </Grid>
        <Grid item md={12} xs={12}>
          <Field
            className="border border-gray focus:outline-none p-4 rounded-lg w-full"
      ...
      <Grid container spacing={2}>
        <Grid item md={12} xs={12}>
          <label className="font-semibold px-2">Contact Information</label>
        </Grid>
        <Grid item md={6} xs={12}>
          <Field
            className="border border-gray focus:outline-none p-4 rounded-lg w-full"
      ...
      <Grid container spacing={2}>
        <Grid item md={12} xs={12}>
          <label className="font-semibold px-2">More Details</label>
        </Grid>
        <Grid item md={6} xs={12}>
          <Field
            className="border border-gray focus:outline-none p-4 rounded-lg w-full"
