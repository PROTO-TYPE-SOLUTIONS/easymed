...
const PersonalDetails = () => {
  ...
  const initialValues = {
        ...
        date_of_birth: profileDetails.date_of_birth ? profileDetails.date_of_birth : '',
  ...
  const mapInsuranceToBackendFormat = (insuranceName, insuranceList) => {
    const selectedInsurance = insuranceList.find(item => item.name === insuranceName);
          ...
          <section className="space-y-2">
            ...
            <div>
              ...
              <Field
                ...
                placeholder="gender"
                name="gender"
                value={profileDetails ? mapGenderToBackendFormat(profileDetails.gender) : ''} // Map the gender value
              >
